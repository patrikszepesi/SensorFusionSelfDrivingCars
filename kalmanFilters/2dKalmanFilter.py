...
class Filter:
    ...
    def __init__(self):
        ...
        #state transition matrix, dt is delta t as time changes, how does our state change
    def F(self):
        # system matrix
        dt = self.dt
    ...
    def Q(self):
        # process noise covariance Q, small value means small motion variances, we trust our model to contrain little noise, this is how much
        q = self.q
        dt = self.dt
        q1 = ((dt**3)/3) * q
        q2 = ((dt**2)/2) * q
    ...
    def H(self):
        # measurement matrix H, transforms from 4d space to 2d space, bc we discard velocity
